...
public class DeviceFaultsGetHandler implements HttpHandler {
    @Override
    public void handleRequest(HttpServerExchange exchange) throws Exception {
    	...
    	List<DeviceFault> devices = processor.getDeviceFaults();
    		
    	exchange.getResponseHeaders().put(
                Headers.CONTENT_TYPE, "application/json");
    	exchange.getResponseSender().send(Config.getInstance().getMapper().writeValueAsString(devices));
